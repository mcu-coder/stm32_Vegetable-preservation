...
* @{
*/
#define PRODUCT_KEY "02f0476952c94348ab55f937c369f7d4"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "95f5df0dfa1642849bdbad775a489551"
...
#define tempUpperThreshold_RATIO                         1
#define tempUpperThreshold_ADDITION                      0
#define tempUpperThreshold_MIN                           0
#define tempUpperThreshold_MAX                           99
#define tempUpperThreshold_LEN                           1
#define tempLowerThreshold_RATIO                         1
#define tempLowerThreshold_ADDITION                      0
#define tempLowerThreshold_MIN                           0
#define tempLowerThreshold_MAX                           99
#define tempLowerThreshold_LEN                           1
#define humiUpperThreshold_RATIO                         1
#define humiUpperThreshold_ADDITION                      0
#define humiUpperThreshold_MIN                           0
#define humiUpperThreshold_MAX                           99
#define humiUpperThreshold_LEN                           1
#define humiLowerThreshold_RATIO                         1
#define humiLowerThreshold_ADDITION                      0
#define humiLowerThreshold_MIN                           0
#define humiLowerThreshold_MAX                           99
#define humiLowerThreshold_LEN                           1
#define CO2_RATIO                         1
#define CO2_ADDITION                      0
#define CO2_MIN                           0
#define CO2_MAX                           2000
#define CO2_LEN                           2
#define CO2Value_RATIO                         1
#define CO2Value_ADDITION                      0
#define CO2Value_MIN                           0
#define CO2Value_MAX                           2000
#define CO2Value_LEN                           2
...
typedef enum
{
    ...
    EVENT_motor,
    EVENT_air_conditioner,
    EVENT_humidifier,
    EVENT_model,
    EVENT_tempUpperThreshold,
    EVENT_tempLowerThreshold,
    EVENT_humiUpperThreshold,
    EVENT_humiLowerThreshold,
    EVENT_CO2Value,
...
typedef struct {
    bool valuemotor;
    bool valueair_conditioner;
    bool valuehumidifier;
    uint32_t valuemodel;
    uint32_t valuetemperature;
    uint32_t valuehumidity;
    uint32_t valuetempUpperThreshold;
    uint32_t valuetempLowerThreshold;
    uint32_t valuehumiUpperThreshold;
    uint32_t valuehumiLowerThreshold;
    uint32_t valueCO2;
    uint32_t valueCO2Value;
} dataPoint_t;

/** User Area Device State Structure */
typedef struct {
    uint8_t flagmotor:1;
    uint8_t flagair_conditioner:1;
    uint8_t flaghumidifier:1;
    uint8_t flagmodel:1;
    uint8_t flagtemperature:1;
    uint8_t flaghumidity:1;
    uint8_t flagtempUpperThreshold:1;
    uint8_t flagtempLowerThreshold:1;
    uint8_t flaghumiUpperThreshold:1;
    uint8_t flaghumiLowerThreshold:1;
    uint8_t flagCO2:1;
    uint8_t flagCO2Value:1;
} dataPointFlags_t;
...
typedef struct {
    ...
    uint8_t valuetempUpperThreshold;
    uint8_t valuetempLowerThreshold;
    uint8_t valuehumiUpperThreshold;
    uint8_t valuehumiLowerThreshold;
    uint16_t valueCO2;
    uint16_t valueCO2Value;
} devStatus_t;
